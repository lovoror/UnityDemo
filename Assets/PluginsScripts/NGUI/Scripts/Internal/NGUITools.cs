...
static public class NGUITools
{
    ...
    static public void PlaySound(FMODAsset clip, float volume, float pitch, bool exclusive)
    {
        string AssetPath = "";
        if (clip != null)
        {
        ...
        var audioSys = MAOBATEC.AudioSystem.instance;
        if (exclusive)
        {
            audioSys.PlayMusic(AssetPath);
        }
        else
        {
            audioSys.PlaySound(AssetPath);
        }
    }
	/// <summary>

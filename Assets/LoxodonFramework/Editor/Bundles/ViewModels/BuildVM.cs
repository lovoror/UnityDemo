...
namespace Loxodon.Framework.Bundles.Editors
{
    ...
    public class BuildVM : AbstractViewModel
    {
        ...
        public BuildTarget BuildTarget
        {
            ...
            set
            {
                if (Set(ref buildTarget, value, () => BuildTarget))
        ...
        public CompressOptions Compression
        {
            ...
            set
            {
                if (Set(ref compression, value, () => Compression))
                    Save();
            }
        }
        ...
        public virtual bool VersionExists()
        {
            ...
            string versionOutput = builder.GetVersionOutput(OutputPath, BuildTarget, DataVersion);
        ...
        public virtual void Build(bool forceRebuild)
        {
            ...
            List<IBundleModifier> bundleModifierChain = CreateBundleModifierChain();
            BundleBuilder builder = new BundleBuilder();
            builder.Build(path, BuildTarget, options, DataVersion, bundleModifierChain);
            ...
            DirectoryInfo dir = new DirectoryInfo(builder.GetPlatformOutput(path, BuildTarget));
            try
            {
                //open the folder 
        ...
        public virtual void CopyToStreamingAssets()
        {
            try
            {
                ...
                DirectoryInfo src = new DirectoryInfo(builder.GetVersionOutput(OutputPath, BuildTarget, DataVersion));
